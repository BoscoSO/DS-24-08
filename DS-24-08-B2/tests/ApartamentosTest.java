...
public class ApartamentosTest {
    ...
    void setup() {
        ...
        Anuncio add1 =new Anuncio(1,140,103,a1);
        Anuncio add2 =new Anuncio(2,170,90,a1);
        Anuncio add3 =new Anuncio(3,170,90,a2);
        Anuncio add4 =new Anuncio(4,150,100,a2);
        Anuncio add5 =new Anuncio(5,150,100,a3);
        Anuncio add6 =new Anuncio(6,80,75,a4);
        Anuncio add7 =new Anuncio(7,100,123,a4);
        Anuncio add8 =new Anuncio(8,100,123,a4);
